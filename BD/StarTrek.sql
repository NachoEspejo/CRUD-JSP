...
CREATE TABLE `tripulante` (
  ...
  `Historia` varchar(9999) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tripulante` (`IdTrip`, `nombre`, `apellidos`, `IdFacc`, `Historia`) VALUES
(1, 'Donelle', 'McLise', 1, 'Primera mujer en tener relaciones diplomáticas con la primera raza extraterrestre'),
(2, 'Carson', 'Readitt', 1, 'Gracias a sus esfuerzos y determinación, fue reconocido como unos de los mejores efectivos de la Federación'),
(3, 'Isahella', 'Hiddsley', 2, 'Primer lider de la casa Klingon'),
(4, 'Porter', 'Schoffler', 2, 'Noble de alto rango de la casa Klingon'),
(5, 'Magdalena', 'Kevlin', 3, 'Fue considerada una marginada en la Tierra, lo que provocó un fuerte odio hacia la Federación, conviertiendose en la primera rebelde y la más peligrosa'),
(6, 'Sonnnie', 'Inglish', 3, 'Es considera la mercenaria más temeraria, en toda la galaxia, ella cualquier tarea, por el precio justo.');
