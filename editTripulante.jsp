...
<html>
    ...
    <body>
        <%
            ...
            String actualizacion = "UPDATE tripulante SET "
                    + "nombre='" + request.getParameter("nombre")
                    + "', apellidos='" + request.getParameter("apellidos")
                    + "', IdFacc=" + Integer.valueOf(request.getParameter("IdFacc"))
                    + ", Historia='" + request.getParameter("Historia")
                    + "' WHERE IdTrip=" + Integer.valueOf(request.getParameter("IdTrip"));
            s.execute(actualizacion);
            out.println("La modificación de la entidad ha sido exitosa.");
